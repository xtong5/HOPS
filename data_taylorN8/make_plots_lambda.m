...
if mode == 1
%     load('data_expcos10N8.mat');
    load('data_expcos100N8.mat');
end
if mode == 2
%     load('data_cos210N8.mat');
    load('data_cos2100N8.mat');
end
if mode == 4
%     load('data_cos410N8.mat');
    load('data_cos4100N8.mat');
end
if mode == 8
%     load('data_cos810N8.mat');
    load('data_cos8100N8.mat');
end
