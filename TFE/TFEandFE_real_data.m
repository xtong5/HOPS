...
% load('TFE_cos2_eps_a2_Nr64_WATERAg.mat')
% load('FE_cos2_eps_a2_WATERAg.mat')
% load('TFE_cos2_eps_a3_Nr64_WATERAg.mat')
% load('FE_cos2_eps_a3_WATERAg.mat')
% load('TFE_cos2_eps_a5_Nr64_WATERAg.mat') 
% load('FE_cos2_eps_a5_WATERAg.mat')
% load('TFE_cos2_eps_a5_Nr64_N24_WATERAg.mat') 
% load('FE_cos2_eps_a5_N24_WATERAg.mat')
load('TFE_cos4_eps_a5_Nr64_WATERAg.mat') % paper
load('FE_cos4_eps_a5_WATERAg.mat')
...
for i=2:size(M,2)
    ...
    conv_err_tfe(i) = abs(Gn_U_fe_norm(i)-Gn_U_fe_norm(i-1));
end
...
for i=1:size(M,2)
  fprintf('%d    %.16g    %g      %.16g      %g      %g\n',M(i),Gn_U_fe_norm(i),...
      conv_err_fe(i),Gn_U_tfe_norm(i),conv_err_tfe(i),...
