function [un] = field_tfe_helmholtz_upper(xi_n,f,p,alphap,betap,eep,eem,Dy,a,Nx,Ny,N)
...
for n=1:N
  ...
  if(n>=1)
    ...
    Su = eep.*ifft( (1i*betap).*fft(eem.*un(:,ell_top,n-1+1)) );
    Jn = Jn - (1.0/a)*f.*Su;
  end
