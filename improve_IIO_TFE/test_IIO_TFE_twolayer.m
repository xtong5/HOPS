...
psi_n = -sigma_u.*nu_u_n- sigma_w.*nu_w_n;
...
tic;
[I_u_n,I_w_n] = twolayer_IIO_TFE(zeta_n,psi_n,f,f_theta,p,k_u,k_w,sigma_u,sigma_w,a,b,c,N_theta,N,N_r,Y_p,Z_p);
[Un,Dr_Un,Dp_Un] = field_tfe_IIO_helmholtz_polar_exterior(I_u_n,f,f_theta,k_u,a,b,p,N_theta,N,N_r,sigma_u,Y_p);
Qn_u = IIO_tfe_helmholtz_polar_exterior(Un,Dr_Un,Dp_Un,f,f_theta,a,b,N,sigma_u,Z_p);
[Wn,Dr_Wn,Dp_Wn] = field_tfe_IIO_helmholtz_polar_interior(I_w_n,f,f_theta,k_w,a,c,p,N_theta,N,N_r,sigma_w,Z_p);
Sn_w = IIO_tfe_helmholtz_polar_interior(Wn,Dr_Wn,Dp_Wn,f,f_theta,a,c,N,sigma_w,Y_p);
t_tfe = toc;
