function [Un,Dr_Un,Dp_Un] = field_tfe_new_IIO_interior(xi_n,f,f_theta,k,a,c,p,N_theta,N,N_r,sigma,Z)
...
%% main loop
D_p = diff_mat_new_interior(p,T_p,Dr,r,k,sigma,a,Z);
...
for n=1:N+1
    ...
    Ln_p=L_n_new_interior(u_n(:,n-1),Zero,xi_n(:,n-1),zeros(N_theta,1),Dr_u_n(:,n-1),...
    ...
    Fn_p = FT(Fn,N_r,N_theta);
    Ln_p=L_n_new_interior(u_n(:,n-1),u_n(:,n-2),xi_n(:,n-1),xi_n(:,n-2),Dr_u_n(:,n-1),...
