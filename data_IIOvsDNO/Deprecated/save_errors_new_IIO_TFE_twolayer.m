...
filename = sprintf('errors_IIO_new_Eps_0.005_Nr32.mat');
L = 2*pi;
...
filename = sprintf('errors_IIO_new_Eps_0.01_Nr32.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.05_Nr32.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.1_Nr32.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.005_Nr32_sing12.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.01_Nr32_sing12.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.05_Nr32_sing12.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.1_Nr32_sing12.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.005_Nr32_sing16.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.01_Nr32_sing16.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.05_Nr32_sing16.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
...
filename = sprintf('errors_IIO_new_Eps_0.1_Nr32_sing16.mat');
[relerr_taylorU,relerr_padeU,nplotU] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOU,relerr_padeIIOU,nplotIIOU] = save_errors_2d_polar(Q_u,Qn_u,Eps,N,N_theta);
[relerr_taylorW,relerr_padeW,nplotW] = save_errors_2d_polar(xi_u,Un,Eps,N,N_theta);
[relerr_taylorIIOW,relerr_padeIIOW,nplotIIOW] = save_errors_2d_polar(S_w,Sn_w,Eps,N,N_theta);
