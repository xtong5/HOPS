...
mode_op = 2; Operater = 'IIO_new'; %1=IIO, 2=IIO_new, 3=DNO
% mode_op = 1; Operater = 'IIO'; 
% mode_op = 3; Operater = 'DNO'; 
...
name3 = sprintf('errors_%s_Eps_0.05_Nr32%s.mat',Operater,mode_sing);
name4 = sprintf('errors_%s_Eps_0.1_Nr32%s.mat',Operater,mode_sing);

% name1 = sprintf('abs_errors_%s_Eps_0.005_Nr32%s.mat',Operater,mode_sing);
% name2 = sprintf('abs_errors_%s_Eps_0.01_Nr32%s.mat',Operater,mode_sing);
% name3 = sprintf('abs_errors_%s_Eps_0.05_Nr32%s.mat',Operater,mode_sing);
% name4 = sprintf('abs_errors_%s_Eps_0.1_Nr32%s.mat',Operater,mode_sing);
...
%     load(name1);err1 = err_padeIIOU;
%     load(name2);err2 = err_padeIIOU;
%     load(name3);err3 = err_padeIIOU;
%     load(name4);err4 = err_padeIIOU;
%     end
end
...
%     error1(i)=err1(Nplot(i)+1);
%     error2(i)=err2(Nplot(i)+1);
%     error3(i)=err3(Nplot(i)+1);
%     error4(i)=err4(Nplot(i)+1);
end
...
% Error0(1) = err1(1);Error0(2) = err2(1);Error0(3) = err3(1);Error0(4) = err4(1);
% Error4(1) = err1(1+4);Error4(2) = err2(1+4);Error4(3) = err3(1+4);Error4(4) = err4(1+4);
% Error8(1) = err1(1+8);Error8(2) = err2(1+8);Error8(3) = err3(1+8);Error8(4) = err4(1+8);
% Error12(1) = err1(1+12);Error12(2) = err2(1+12);Error12(3) = err3(1+12);Error12(4) = err4(1+12);
% Error16(1) = err1(1+16);Error16(2) = err2(1+16);Error16(3) = err3(1+16);Error16(4) = err4(1+16);
...
title('Error versus $\varepsilon$','interpreter','latex');
...
%     filename = sprintf('fig_absErrrorVsN_%s%s', Operater,mode_sing);
%     saveas(1,filename,'epsc');
%     filename = sprintf('fig_absErrrorVsEps_%s%s', Operater,mode_sing);
%     saveas(2,filename,'epsc');
end