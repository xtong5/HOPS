...
if mode == 1
    load('data_expcos10N12.mat');
%     load('data_expcos100N12.mat');
end
if mode == 2
    load('data_cos210N12.mat');
%     load('data_cos2100N12.mat');
end
if mode == 4
    load('data_cos410N12.mat');
%     load('data_cos4100N12.mat');
end
if mode == 8
    load('data_cos810N12.mat');
%     load('data_cos8100N12.mat');
end
