...
FE_app(M,f0,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos2100_eps_VACAg';
FE_app(M,f2,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos4100_eps_VACAg';
FE_app(M,f4,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos8100_eps_VACAg';
FE_app(M,f8,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
