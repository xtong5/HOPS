...
Eps_max = 0.15*a;
name = 'expcos15_eps_VACAg';
FE_app_pade(M,f0,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos215_eps_VACAg';
FE_app_pade(M,f2,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos415_eps_VACAg';
FE_app_pade(M,f4,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
...
Eps_max = 0.15*a;
name = 'expcos15_eps_VACAu';
FE_app_pade(M,f0,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos215_eps_VACAu';
FE_app_pade(M,f2,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos415_eps_VACAu';
FE_app_pade(M,f4,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
...
Eps_max = 0.15*a;
name = 'expcos15_eps_WATERAg';
FE_app_pade(M,f0,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos215_eps_WATERAg';
FE_app_pade(M,f2,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos415_eps_WATERAg';
FE_app_pade(M,f4,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
...
Eps_max = 0.15*a;
name = 'expcos15_eps_WATERAu';
FE_app_pade(M,f0,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos215_eps_WATERAu';
FE_app_pade(M,f2,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
name = 'cos415_eps_WATERAu';
FE_app_pade(M,f4,N_theta,theta,a,b,N,Eps_max,N_eps,OUT,IN,name);
