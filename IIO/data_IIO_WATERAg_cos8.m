...
tic;
U_n = twolayer_dno_tfe_helmholtz_polar(zeta_n,psi_n,f8,f8_theta,tau2,...
    p,k_u,k_w,a,b,c,N_theta,N,N_r);
[Un,Dr_Un,Dp_Un] = field_tfe_helmholtz_polar_exterior(U_n,f8,f8_theta,k_u,a,b,p,N_theta,N,N_r);
Gn_tfe_u = dno_tfe_helmholtz_polar_exterior(Dr_Un,Dp_Un,f8,f8_theta,k_u,a,b,p,N_theta,N,N_r);
% W_n = U_n - zeta_n;
...
filename = sprintf('TFE_cos8_eps%g_Nr%g_N%g_WATERAg.mat',Eps,N_r,N);
