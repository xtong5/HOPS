...
anp= field_fe_helmholtz_polar_exterior(xi_u,f,f_theta,k_u,a,p,N_theta,N-s,sigma_u,Y_p);
...
dnp = field_fe_helmholtz_polar_interior(xi_w,f,f_theta,k_w,a,p,N_theta,N-s,sigma_w,Z_p);
