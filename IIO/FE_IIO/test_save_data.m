...
N_theta = 64;N = 16;M = 21;N_eps = 101;
a = 0.025;b = 10*a;Eps_max = 0.1*a;
...
save(filename,'M','lambda','N_theta','N','N_eps','Eps_max','OUT','IN',...
    ...
    'U_n_dno','W_n_dno','Gn_U_n_dno','Gn_W_n_dno',...
    'U_norm','W_norm','Iu_norm','Iw_norm','Qu_norm','Sw_norm','Gn_U_norm','Gn_W_norm','BU_norm',...
    'U_norm_dno','W_norm_dno','Gn_U_norm_dno','Gn_W_norm_dno')
