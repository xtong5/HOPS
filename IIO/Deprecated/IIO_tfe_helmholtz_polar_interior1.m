function [Qn_tfe] = IIO_tfe_helmholtz_polar_interior1(I_u_n,f,f_theta,k,a,c,p,N_theta,N,N_r,sigma,eta)
% should be I_u not I_u_n
d=a-c; 
[Un,Dr_Un,Dp_Un] = field_tfe_IIO_helmholtz_polar_interior(I_u_n,f,f_theta,k,a,c,p,N_theta,N,N_r,sigma,eta);
