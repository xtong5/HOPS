...
fprintf('test_dno_tfe_TM_twolayer\n');
fprintf('---------------------------------------------\n');
...
tic;
[U_n,W_n] = dno_tfe_TM_twolayer(Nzeta_n,psi_n,f,f_theta,...
    p,k_u,k_w,eta,tau2,a,b,c,N_theta,N,N_r);
[~,Dr_Un,Dp_Un] = field_tfe_helmholtz_polar_exterior(U_n,f,f_theta,k_u,a,b,p,N_theta,N,N_r);
Gn_tfe_u = dno_tfe_helmholtz_polar_exterior(Dr_Un,Dp_Un,f,f_theta,k_u,a,b,p,N_theta,N,N_r);
[~,Dr_Wn,Dp_Wn] = field_tfe_helmholtz_polar_interior(W_n,f,f_theta,k_w,a,c,p,N_theta,N,N_r);
