function [Un,Dr_Un,Dp_Un] = field_tfe_IIO_helmholtz_polar_exterior(xi_n,f,f_theta,k,a,b,p,N_theta,N,N_r,sigma,Y)
...
%% main loop
D_p = diff_mat_IIO_exterior(p,T_p,Dr,r,k,sigma,a,Y);
