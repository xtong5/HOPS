...
\noindent\textbf{\large LGSPR  with (ALMA), vacuum and vacuum, $\cos(4\theta)$, $\bar{g} = 0.0025, 0.05, 0.5, 1$}
\begin{figure}[H]
	\centering
	\subfigure
	{\includegraphics[width=0.35\textwidth]
...
\newpage
\noindent\textbf{\large LGSPR  with (BFPV), vacuum and vacuum, $\cos(2\theta)$, $\bar{g} = 0.0025, 0.05, 0.5, 1$}
\begin{figure}[H]
	\centering
	\subfigure
	{\includegraphics[width=0.35\textwidth]
...
\newpage
\noindent\textbf{\large LGSPR  with (BFPV), vacuum and vacuum, $\cos(4\theta)$, $\bar{g} = 0.0025, 0.05, 0.5, 1$}
\begin{figure}[H]
	\centering
	\subfigure
	{\includegraphics[width=0.35\textwidth]
