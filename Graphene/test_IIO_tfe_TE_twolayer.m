% test_IIO_fe_TE_twolayer.m
%
% Script to test IIO solvers in polar (two layers) for Graphene TE mode 
%
% XT 9/19
...
tic;
[I_u_n,I_w_n] = IIO_fe_TE_twolayer(zeta_n,psi_n,f,f_theta,rho,...
