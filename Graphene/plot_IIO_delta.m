...
ylabel('$\tilde{\Delta}_p$','interpreter','latex','FontSize',16);
title('$\tilde{\Delta}_p$(TE)','interpreter','latex','FontSize',16);
...
xlabel('$\lambda$','interpreter','latex','FontSize',16);
ylabel('$\tilde{\Delta}_p$','interpreter','latex','FontSize',16);
title('$\tilde{\Delta}_p$(TM)','interpreter','latex','FontSize',16);
legend('$p=0$','$p=1$','$p=2$','$p=3$','$p=4$','interpreter','latex','FontSize',14);
